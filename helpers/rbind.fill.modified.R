# Modified version of plyr::rbind-fill that fills missing columns with 0
# instead of NA
library(plyr)
# https://raw.githubusercontent.com/hadley/plyr/main/R/rbind-fill.r
